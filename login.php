...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($password)) $errors[] = 'Password là bắt buộc.';
    if (empty($errors)) {
        ...
        if ($user && password_verify($password, $user['password_hash'])) {
            ...
            $errors[] = 'Email hoặc password không đúng.';
        }
    }
}
?>
		...
		<div class="login">
			...
			<div class="col-md-6 login-do">
				<div class="login-mail">
					<input type="text" name="email" placeholder="Email" required="" value="<?php echo htmlspecialchars(
$email); ?>">
